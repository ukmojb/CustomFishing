...
public class RenderCFFish extends RenderFish
{
     ...
     */
//    @Override
//    public void doRender(CFEntityFishHook entity, double x, double y, double z, float entityYaw, float partialTicks)
//    {
...
//     */
//    @Override
//    protected ResourceLocation getEntityTexture(CFEntityFishHook entity)
//    {
